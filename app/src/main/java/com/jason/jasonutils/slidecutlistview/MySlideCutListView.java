...
public class MySlideCutListView extends ListView {
	...
	public MySlideCutListView(Context context) {
		this(context, null);
	}

	public MySlideCutListView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public MySlideCutListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean dispatchTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN: {
			...
			MLog.i("哈哈", "dispatchTouchEvent ACTION_DOWN isSlide = " + isSlide);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		if (isSlide && slidePosition != AdapterView.INVALID_POSITION) {
			...
			switch (action) {
			case MotionEvent.ACTION_MOVE:
				MLog.i("哈哈", "onTouchEvent ACTION_MOVE isSlide = " + isSlide);
				if (isObstruct) {
