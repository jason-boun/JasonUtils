...
public class ChooseCutPic_Activity extends Activity {
	
	private static final int TAKE_PICTURE = 0;//拍照
	private static final int CHOOSE_PICTURE = 1;//从相册选择
	private static final int CROP = 2;//图片剪切
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.choose_cut_pic_activity);
	...
	private void init() {
		...
		this.findViewById(R.id.btn).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				showPicturePicker(ChooseCutPic_Activity.this,false);//即拍即显示
			}
		});
		this.findViewById(R.id.btn2).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				showPicturePicker(ChooseCutPic_Activity.this,true);//截图后显示
			}
		});
	}
