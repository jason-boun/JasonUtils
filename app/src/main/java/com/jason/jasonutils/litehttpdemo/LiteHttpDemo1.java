package com.jason.jasonutils.litehttpdemo;
...
public class LiteHttpDemo1 extends Activity {
    protected String TAG = LiteHttpDemo1.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.litehttp_demo_activity);
        initViews();
        activity = this;
    ...
    private void initViews() {
        ...
        mAdapter = new ArrayAdapter<String>(this, R.layout.litehttp_demo_list_item, R.id.tv_item,
        ...
        switch (which) {
            ...
            case 8:
                ...
                class FastJson extends Json {
                    ...
                    public <T> T toObject1(String s, Type type) {
					...
					@Override
					public <T> T toObject(String arg0,
